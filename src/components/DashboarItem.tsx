...
const DashboarItem = ({ title, info, smallInfo }: DashboarItemProps) => {
  return (
    <div className="flex h-24 w-48 sm:w-64 sm:h-28 flex-col justify-between rounded-xl bg-gray-200 px-3 py-2 text-slate-600 shadow-md">
      <div className="flex w-full items-baseline justify-between">
        <span className="text-sm md:text-[20px] font-medium ">{title}</span>
