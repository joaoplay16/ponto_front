      ...
      <div className="flex gap-8 flex-wrap">
        ...
        {!editMode && (
          <div className="flex max-w-96 flex-col gap-2 rounded-xl bg-gray-200 px-3 py-2 text-sm text-slate-600 shadow-md">
            ...
            <span className="font-medium">
              E-mail <span className="font-normal">{userInfo.user?.email}</span>
            </span>
            <span className="font-medium">
              Celular{" "}
            ...
            <span className="font-medium">
              Cargo <span className="font-normal">{userInfo.user?.cargo}</span>
            </span>
            <div className="self-start">
              <Button onClick={() => setEditMode(true)}>Alterar perfil</Button>
            </div>
          </div>
        )}
